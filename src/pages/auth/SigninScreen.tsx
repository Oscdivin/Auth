...
<div className="max-sm:w-screen max-md:w-screen
        max-lg:w-screen max-xl:w-95 max-2xl:w-99">
<form action="" className="w-[40%] h-[0vh] bg-[#fff] flex flex-col justify-center
...
className="w-[80%] h-[45px] outline-none rounded-[7px] 
 px-[8px] text-[#000] text-[15px] border-[1px] border-[gray]"/>
