  ...
  return (
    <div>
      ...
      <div className="w-[90%] h-[80vh]  rounded-[7px]
       ...
       <form action=""className="w-[80%] h-[75vh] flex justify-center items-center flex-col
         gap-4 max-sm:w-screen max-md:w-screen max-lg:w-screen">
          <div className="w-[100%] flex items-center justify-center h-[60px]">
<span className="w-[80%] text-[30px] flex items-center">Sign-In</span>
</div>
...
<button className="py-[10px] px-[20px] bg-[green] rounded-[7px] text-[#fff]">SignIn</button>
